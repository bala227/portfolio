    ...
    <div className='home'>
        ...
        <div className='homebody' id='Home'>
            <div className='first' id='first'>
                ...
                <div className='icons'>
                    <a href="https://www.instagram.com/_helixul_/" target='blank' rel="noopener noreferrer"><InstagramIcon style={{fontSize:50,color:"#fd1d1d",marginRight:13,cursor:"pointer"}}/></a>
                    <a href="https://www.linkedin.com/in/bala-subramanian-s-3a95a8261/" target='blank' rel="noopener noreferrer"><LinkedInIcon style={{fontSize:50,color:"#0A66C2",marginRight:13,cursor:"pointer"}}/></a>
                    <a href="https://github.com/bala227" target='blank' rel="noopener noreferrer"><GitHubIcon style={{fontSize:50,marginRight:13,cursor:"pointer",color:"white"}}/></a>
                    <a href="https://x.com/K_arthi7777" target='blank' rel="noopener noreferrer"><XIcon style={{fontSize:50,cursor:"pointer",color:"white"}}/></a>
                </div>
